-- BUDG-012 Phase 4 — apply_rebalance RPC for atomic tx + overrides apply.
...
revoke all on function public.apply_rebalance(jsonb, jsonb) from public;
grant execute on function public.apply_rebalance(jsonb, jsonb) to authenticated;
